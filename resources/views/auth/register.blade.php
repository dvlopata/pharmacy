            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="surname" class="col-md-4 col-form-label text-md-end">{{ __('Прізвище') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="dateOfBirth" class="col-md-4 col-form-label text-md-end">{{ __('Дата народження') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="region" class="col-md-4 col-form-label text-md-end">{{ __('Область') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="postNumber" class="col-md-4 col-form-label text-md-end">{{ __('Номер/індекс відділення') }}</label>

                            <div class="col-md-6">
                                <input id="postNumber" type="text" class="form-control @error('postNumber') is-invalid @enderror" name="postNumber" value="{{ old('postNumber') }}" required autocomplete="postNumber" autofocus>
