...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Додавання аптеки</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{route('admin.pharmacy.store')}}" method="POST" class="w-25">
                        @csrf
                        <div class="form-group">
                            <input type="text" class="form-control" name="city" placeholder="Місто" value="{{old('city')}}">
                            @error('city')
                            <div class="text-danger">Це поле необхідно заповнити!</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="region" placeholder="Область" value="{{old('region')}}">
                            @error('region')
                            <div class="text-danger">Це поле необхідно заповнити!</div>
                            @enderror
                        </div>
